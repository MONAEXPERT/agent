...
remoteagent and the remoteagent.online cloud are designed with the modern EU
...
| **EU AI Act** | AI systems | remoteagent + engine (limited risk) | Transparency obligations implemented; documentation below |
...
- **Open-source client (remoteagent)** — free, MIT-licensed, supplied
...
See the dedicated [AI Act documentation](AI-ACT.md). Summary: remoteagent
...
| Logging & audit | Immutable-style audit log of agent actions, LLM calls, key events + tamper-evident hash-chained local audit (`remoteagent audit verify`) |
