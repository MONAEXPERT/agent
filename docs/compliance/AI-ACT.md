...
| Record-keeping | Full audit log of tasks, tool calls, LLM calls, and results (`mona_audit_log`, `mona_messages`) + hash-chained local decision log (`~/.remoteagent/audit.jsonl`) |
