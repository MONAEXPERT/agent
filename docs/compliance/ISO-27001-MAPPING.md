...
This mapping supports organizations building an ISMS around the remoteagent
deployment. "Implemented by remoteagent/platform" means the control exists in
...
- **A.12.4 Logging and monitoring** — full audit log (messages, brain steps,
  ...
  verification (`remoteagent audit verify`).
