...
automation and control systems (IACS). The remoteagent daemon can be treated as
...
| FR 3 — System integrity | Protect against manipulation | TLS with certificate verification; code served from signed Git tags; local policy and audit files are hash-chained and tamper-evident (`remoteagent audit verify`) |
