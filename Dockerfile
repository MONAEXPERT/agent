# remoteagent — containerized device agent
# Non-root, minimal surface. Data (credentials, policy, audit, memory)
# lives in /home/remoteagent/.remoteagent — mount a volume there.
#
# Build:  docker build -t remoteagent .
...
ENV NODE_ENV=production \
    HOME=/home/remoteagent \
    MONA_METRICS_PORT=4301
WORKDIR /app
COPY --from=build /app /app
RUN addgroup -S remoteagent && adduser -S remoteagent -G remoteagent \
 && mkdir -p /home/remoteagent/.remoteagent \
 && chown -R remoteagent:remoteagent /home/remoteagent /app
USER remoteagent
EXPOSE 4301
