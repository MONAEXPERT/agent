...
chmod +x "$INSTALL_DIR/agent/bin/mona-agent.js"
...
ln -sf "$INSTALL_DIR/agent/bin/mona-agent.js" "$BIN_DIR/mona-agent"
...
echo ""
echo -e "  1. Get your API key:   ${CYAN}https://agent.mona.expert/mona/dashboard${RESET}"
